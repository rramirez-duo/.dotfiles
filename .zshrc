...
alias wifi_interface='ip link show | grep wlp | cut -d ':' -f 2'
alias wifi='sudo ip link set $(wifi_interface) down && sudo ip link set $(wifi_interface) up && sudo systemctl restart NetworkManager && nm-applet &'
...
alias hopdo='sshuttle --dns -vvr nt-cloud-dev 0/0'
